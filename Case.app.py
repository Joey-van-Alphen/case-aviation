...
st.markdown("Om de tweede dataset te kunnen koppelen hebben we de eerste tabel alleen gefilterd op de totaal data van alle luchthavens. Met behulp van de **.merge()** methode en een **Left join** hebben we nu één tabel. We zien echter dat de eerste 6 jaar van de variabele 'Totale post vervoer missen'. Deze vullen we op met het gemiddelde van deze hele kolom met **.fillna()**. Ook voegen we 5 kolommen toe: Totale uitstoot sinds meting, vulgraad_pax, vulgraad_vracht, vulgraad_post en vulgraad_totaal")
